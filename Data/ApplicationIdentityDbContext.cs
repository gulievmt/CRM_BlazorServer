...
namespace CRMBlazorServerRBS.Data
{
    public partial class ApplicationIdentityDbContext : IdentityDbContext<ApplicationUser, ApplicationRole, string>
    {
        ...
        public DbSet<CRMBlazorServerRBS.Models.ApplicationUser> ApplicationUser { get; set; }
        public DbSet<CRMBlazorServerRBS.Models.ApplicationRole> ApplicationRole { get; set; }
    }
}